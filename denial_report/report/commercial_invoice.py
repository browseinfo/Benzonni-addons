...
class commercial_invoice(report_sxw.rml_parse):
    ...
    def __init__(self, cr, uid, name, context=None):
        super(commercial_invoice, self).__init__(cr, uid, name, context=context)
...
class report_commercial_invoice_qweb(osv.AbstractModel):
    _name = 'report.denial_report.report_commercial_invoice'
    _inherit = 'report.abstract_report'
    _template = 'denial_report.report_commercial_invoice'
    _wrapped_report_class = commercial_invoice
